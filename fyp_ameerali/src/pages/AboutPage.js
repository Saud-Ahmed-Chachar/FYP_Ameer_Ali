...
const AboutPage = () => {
  return (
    <>
      {/* About Page and Our Mission sections with images */}
      <div className="relative flex items-top justify-center min-h-screen bg-white sm:items-center sm:pt-0">
        <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
          ...
          <div className="mt-8 overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex justify-center items-center">
                <img src={aboutUs} alt="About Us" className="max-w-xs rounded-lg shadow-lg" />
              </div>
            </div>
          </div>
          {/* Our Mission section */}
          <div className="mt-8 overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex justify-center items-center">
                <img src={mission} alt="Our Mission" className="max-w-xs rounded-lg shadow-lg" />
              </div>
              <div className="p-6 bg-gray-100 sm:rounded-lg">
                <h1 className="text-4xl sm:text-5xl text-gray-800 font-extrabold tracking-tight">
                  Our Mission
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <form className="p-6 flex flex-col justify-center">
              <div className="flex flex-col">
                ...
                <input type="name" name="name" id="name" placeholder="Full Name" className="w-full mt-2 py-3 px-3 rounded-lg bg-white border border-gray-400 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none" />
              </div>
            ...
            <div className="flex flex-col mt-2">
              ...
              <button type="submit" className="md:w-32 bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-lg mt-3 transition ease-in-out duration-300">
                Submit
              </button>
            </form>
          </div>
